...
export default function Normal() {
    return (
        <S.Container>
            <S.LeftContainer>
                <Tooltip direction="leftTop" content={<Prompt />} hover>
                    <S.Content className="content">LT</S.Content>
                </Tooltip>
                <Tooltip direction="left" content={<Prompt />} hover>
                    <S.Content className="content">Left</S.Content>
                </Tooltip>
                <Tooltip direction="leftBottom" content={<Prompt />} hover>
                    <S.Content className="content">LB</S.Content>
                </Tooltip>
            </S.LeftContainer>
            <div style={{ display: "flex", flexDirection: "column" }}>
                <S.TopContainer>
                    <Tooltip direction="topLeft" content={<Prompt />} hover>
                        <S.Content className="content">TL</S.Content>
                    </Tooltip>
                    <Tooltip direction="top" content={<Prompt />} hover>
                ...
                <S.BottomContainer>
                    <Tooltip direction="bottomLeft" content={<Prompt />} hover>
                        <S.Content className="content">BL</S.Content>
                    </Tooltip>
                    <Tooltip direction="bottom" content={<Prompt />} hover>
                        <S.Content className="content">Bottom</S.Content>
                    </Tooltip>
                    <Tooltip direction="bottomRight" content={<Prompt />} hover>
                        <S.Content className="content">BR</S.Content>
                    </Tooltip>
                </S.BottomContainer>
            </div>
            <S.RightContainer>
                <Tooltip direction="rightTop" content={<Prompt />} hover>
                    <S.Content className="content">RT</S.Content>
                </Tooltip>
                <Tooltip direction="right" content={<Prompt />} hover>
